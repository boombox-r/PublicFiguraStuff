...
-- Variables
local MODEL = models.BlackHole.model.Head -- This is the path to the ModelGroup that contains center, outline, and ring.
local AMIMATION_PATH = "BlackHole.model" -- This is the path to the black hole's model file
local frame = 0;
local colorType = "orange" -- Orange is custom, I was too lazy to change it to custom
...
function events.render(delta, context)
    ...
    if context == "FIRST_PERSON" then
        confetti.modelinstances:setVisible(false)
    else
        confetti.modelinstances:setVisible(true)
    end
